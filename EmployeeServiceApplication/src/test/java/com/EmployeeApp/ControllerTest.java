...
import com.EmployeeApp.Controller.EmployeeAPI;
...
public class ControllerTest {
	...
	public void initializeEmployee() {
		...
		employeeDTO.setEmpName("Vishnu");
		employeeDTO.setEmpPhone(982365892L);
	...
	public void getEmployeeTest() throws Exception {
		Mockito.when(service.displayEmployee()).thenReturn(empList);
